					...
					h.Div(h.Class("modal-body"),
						...
						h.Div(h.Class("flex_layout"),
							h.Div(h.Class("bookmark_edit_layout_flex_5"),
								h.Img(h.ID("bookmark_favicon_display"), h.Class(common.ClassCond("bookmark_favicon_preview", "invert", bm.InvertFaviconColor)), h.Src("/bm/favicon/"+bm.ID.Val+"?t="+bm.TStamp))),
