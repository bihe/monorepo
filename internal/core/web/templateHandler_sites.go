...
func (t *TemplateHandler) DisplaySites() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		base.Layout(
			common.CreatePageModel(sitesBaseURL, "Available Apps",
				search, sitesFavicon, t.Version, t.Build, t.Env, *user, t.Applications,
			),
			html.SiteStyles(),
...
func (t *TemplateHandler) ShowEditSites() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		base.Layout(
			common.CreatePageModel(sitesBaseURL, "Edit Apps",
				search, sitesFavicon, t.Version, t.Build, t.Env, *user, t.Applications),
			html.SiteEditStyles(),
