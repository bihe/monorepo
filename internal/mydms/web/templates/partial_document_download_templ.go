...
func DisplayDocumentDownload(doc document.Document) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if doc.ID != "" && doc.FileName != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `partial_document_download.templ`, Line: 10, Col: 18}
			}
...
func DisplayTempDocumentUpload(fileName, tempID, errMsg string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if errMsg == "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `partial_document_download.templ`, Line: 67, Col: 47}
			}
			...
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(templates.Ellipsis(errMsg, 60, "..."))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `partial_document_download.templ`, Line: 80, Col: 86}
			}
