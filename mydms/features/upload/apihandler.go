...
func (h *Handler) UploadFile(c echo.Context) error {
	...
	logging.LogWithReq(c.Request(), h.log, "upload.UploadFile").Debugf("trying to upload file: '%s'", file.Filename)
	...
	if err != nil {
		...
		if ioerr != nil {
			logging.LogWithReq(c.Request(), h.log, "upload.UploadFile").Warnf("Clean-Up file-upload. Could not delete temp file: '%s': %v", uploadPath, ioerr)
		}
